...
assert(staticScripts.every(({ version }) => version === 'fos-runtime-004'), 'Every static runtime controller must use the FOS-RUNTIME-004 source version.');
assert(html.includes('<meta name="founder-os-build" content="fos-runtime-004" />'), 'The canonical source build marker must match FOS-RUNTIME-004.');
...
assert(staticStyles.every((version) => version === 'fos-runtime-004'), 'Every static stylesheet must use the FOS-RUNTIME-004 source version.');
