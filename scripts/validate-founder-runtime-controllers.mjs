...
assert(staticScripts.every(({ version }) => version === 'fos-actions-009'), 'Every static runtime controller must use the FOS-ACTIONS-009 source version.');
assert(html.includes('<meta name="founder-os-build" content="fos-actions-009" />'), 'The canonical source build marker must match FOS-ACTIONS-005.');
...
assert(staticStyles.every((version) => version === 'fos-actions-009'), 'Every static stylesheet must use the FOS-ACTIONS-009 source version.');
