# Natural Nation Documentation and GitHub Pages

This folder now serves two approved purposes:
...
The clean Founder OS page preserves the current Release 2 functionality:

- Natural Nation Glass theme
- Release 2 operating modules
- AI Build Orchestrator OP-002
- BUILD-NNCC-002 selected item
- Right-side build queue
- Package target buttons
- AI execution plan
