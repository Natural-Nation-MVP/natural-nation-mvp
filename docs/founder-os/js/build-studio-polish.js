...
function loadExecutionModules() {
  loadScriptOnce('./js/processing-status.js?v=processing-v4&release=founder-review', 'data-processing-status-loader');
  loadScriptOnce('./js/canonical-build-studio.js?v=processing-v4&release=founder-review', 'data-canonical-build-loader');
  ...
  loadScriptOnce('./js/ai-orchestration.js?v=processing-v4&release=founder-review', 'data-ai-orchestration-loader');
  loadScriptOnce('./js/build-dispatch-bridge.js?v=processing-v4&release=founder-review', 'data-build-dispatch-bridge-loader');
