...
function loadExecutionModules() {
  loadScriptOnce('./js/processing-status.js?v=processing-v3&release=gpose-recovery', 'data-processing-status-loader');
  loadScriptOnce('./js/canonical-build-studio.js?v=processing-v3&release=gpose-recovery', 'data-canonical-build-loader');
  ...
  loadScriptOnce('./js/ai-orchestration.js?v=processing-v3&release=gpose-recovery', 'data-ai-orchestration-loader');
  loadScriptOnce('./js/build-dispatch-bridge.js?v=processing-v3&release=gpose-recovery', 'data-build-dispatch-bridge-loader');
