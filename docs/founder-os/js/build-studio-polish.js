...
function loadExecutionModules() {
  loadScriptOnce('./js/processing-status.js?v=processing-v1&release=modal-v2', 'data-processing-status-loader');
  loadScriptOnce('./js/canonical-build-studio.js?v=processing-v1&release=modal-v2', 'data-canonical-build-loader');
  ...
  loadScriptOnce('./js/ai-orchestration.js?v=processing-v1&release=modal-v2', 'data-ai-orchestration-loader');
  loadScriptOnce('./js/build-dispatch-bridge.js?v=processing-v1&release=modal-v2', 'data-build-dispatch-bridge-loader');
