...
The inventory covers Founder Home, workspace navigation, Workspace Discovery, workspace lifecycle management, planning and Blueprint actions, Build Work, task details, the Founder Action Center, the Approval Inbox, Mission Control, AI task execution, and workspace-scoped knowledge search.
...
### Duplicate planning-review ownership
...
### Mission Control legacy actions
...
| Knowledge search | `workspace-knowledge-scope.js` |
...
- Single ownership for planning review and Blueprint approval.
- Removal of the duplicate local approval runtime.
- Removal of unowned Build Studio button controls.
- Navigation Manager usage by the Action Center, Mission Control, and Founder utility actions.

The validator is part of both stabilization and deployment gates.
