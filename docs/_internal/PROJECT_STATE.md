...
Canonical knowledge base: docs/_internal/KNOWLEDGE/INDEX.md

Phase 4 roadmap: docs/_internal/RELEASES/PHASE-4-ROADMAP.md

Founder OS Vision v2: docs/_internal/RELEASES/PHASE-4-FOUNDER-OS-VISION-V2.md

Gateway API v1: docs/_internal/RELEASES/PHASE-4-GATEWAY-API-V1.md

Phase 4.2 completion: docs/_internal/RELEASES/PHASE-4.2-GITHUB-MANAGED-GATEWAY-COMPLETE.md

Gateway API v2 approval contract: docs/_internal/ARCHITECTURE/GATEWAY-API-V2-BLUEPRINT-APPROVAL.md

Live action flow audit: docs/_internal/RELEASES/PHASE-4.3-LIVE-ACTION-FLOW-AUDIT.md

Canonical approval completion: docs/_internal/RELEASES/PHASE-4.3-CANONICAL-BLUEPRINT-APPROVAL-COMPLETE.md

Workspace isolation cleanup: docs/_internal/RELEASES/PHASE-4.4-WORKSPACE-ISOLATION-CLEANUP.md

Command Center UX v1.1: docs/_internal/RELEASES/COMMAND-CENTER-UX-V1.1.md

Workspace Discovery and Blueprint Engine: docs/_internal/RELEASES/WORKSPACE-DISCOVERY-BLUEPRINT-ENGINE.md

Natural Nation Workspace Discovery v1: docs/_internal/RELEASES/NATURAL-NATION-WORKSPACE-DISCOVERY-V1.md

Explainability First: docs/_internal/GOVERNANCE/NNOS-UX-001-EXPLAINABILITY-FIRST.md

Execution Action Bar Standard: docs/_internal/GOVERNANCE/NNOS-UX-002-EXECUTION-ACTION-BAR.md

End-to-End Vertical Slice: docs/_internal/GOVERNANCE/NNOS-FLOW-001-END-TO-END-VERTICAL-SLICE.md

Blueprint Validation Engine Milestone: docs/_internal/RELEASES/BLUEPRINT-VALIDATION-ENGINE-MILESTONE.md

Blueprint Approval Transaction v0.1: docs/_internal/RELEASES/BLUEPRINT-APPROVAL-TRANSACTION-V0.1.md

Decision Ledger: docs/_internal/DECISIONS/DECISION-LEDGER.md
...
- Build Studio remains blocked until `docs/_internal/EXECUTION-PACKAGES/NN-BUILD-001.json` exists and is valid.
...
Approval must validate required Blueprint fields, workspace and version availability, unresolved critical decisions, repository configuration, required components, authentication, authorization, and namespace ownership before confirming transaction success.
...
The live interface must not claim canonical approval until the Gateway confirms the atomic repository write and Founder OS verifies the published Blueprint and `NN-BUILD-001` with the matching transaction ID in the repository-backed site.
